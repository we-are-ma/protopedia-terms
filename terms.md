...
利用規約「ProtoPedia利用規約」（以下「本利用規約」といいます。）は、一般社団法人MA（以下「当法人」）が情報提供等を行うサービス「ProtoPedia」（以下「本サービス」といいます。）の利用に関する条件について定めるものです。
...
4. ユーザーは、作品情報等の内容に起因して発生した一切の損害について賠償責任を負うと共に、以下の各号に掲げる送信またはその恐れのある送信をしないものとします。
    ...
    h. わいせつ、児童ポルノ、児童買春、ポルノ小説・写真、性的交渉の勧誘、その他猥褻な内容を含む送信
