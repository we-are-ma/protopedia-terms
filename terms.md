...
6. ユーザーが情報の記載を行った時点で、その送信内容を当法人および当法人が認めた第三者が無償で二次利用（雑誌への掲載許可など。複製・公開・送信・出版・翻訳・翻案・編集・転載なども含みます）することを許諾したものとみなします。なお、この場合、当該ユーザーは、当法人に対し、当該作品情報等の著作者人格権を行使しないものとします。
7. ユーザーは、作品情報等および本サービスの利用履歴が、本サービスおよび第三者提供サービス上で公開される場合があることを、予め承諾するものとします。
8. ユーザーが限定共有機能、もしくは下書き機能を利用して作品情報等を登録した場合であっても、以下の各号のいずれかに該当すると当法人が判断した場合には、当法人は、当該ユーザーの同意なく、当該作品情報等の公開ステータスを一般公開に変更できるものとします。なお、公開ステータスの変更に際し、当該ユーザーに通知するよう努めますが、これを保証するものではありません。
    - コンテスト等の企画への応募目的で登録されたものであり、当該企画の応募要件に「一般公開」が明示されている場合
    - 別途利用規約などにおいて、登録された作品を一般公開する旨があらかじめ定められている場合
    - その他、当法人が合理的と判断する場合
9. 本サービスにおいて、受賞作品（受賞バッジのついている作品）は、一般公開からの公開範囲の変更（削除や下書きなど）はできないものとします。
